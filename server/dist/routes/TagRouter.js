...
class TagRouter {
    ...
    getAll(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const tags = yield tag_queries_1.default.getAll();
    ...
    getOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tag = yield tag_queries_1.default.getOne(id);
            if (tag) {
    ...
    add(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.body.name && typeof req.body.name === 'string') {
                const tag = yield tag_queries_1.default.add(req.body);
                res.json({ message: 'Success', tag });
            }
            else {
    ...
    edit(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            let id = parseInt(req.params.id);
            const tag = yield tag_queries_1.default.edit(id, req.body);
            res.json({ message: 'Success', tag });
        });
    }
    remove(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            let id = parseInt(req.params.id);
            try {
                yield tag_queries_1.default.remove(id);
